...
This repository provides a Playwright + Pytest POM-based QA suite for a real-time domain application. It includes **35 page objects** and **35 test cases** (positive/negative coverage, API testing, and complex flows).

## Structure

- `pages/`
  - `base_page.py`: Shared POM helpers and a `PageSpec` definition.
  - `realtime_pages.py`: 35 real-time app pages modeled as POM specs.
- `tests/`
  - `test_realtime_suite.py`: 35 test cases (UI + API + complex flows).
